...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public long insertLocation() {
        ...
        // Insert ContentValues into database and get a row ID back
        long locationRowId = database.insert(WeatherContract.LocationEntry.TABLE_NAME, null, contentValues);
        ...
        // Move the cursor to a valid database row
        assertTrue("Error : no record returned from LocationEntry", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error : current location query validateion failed",
